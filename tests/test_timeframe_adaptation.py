...
def test_mean_reversion_min_hold_scales():
    ...
    assert strat_fast._base_min_hold_bars == 10
    assert strat_slow._base_min_hold_bars == 10
    assert strat_default_30m._base_min_hold_bars == 9
    assert strat_default_1h._base_min_hold_bars == 7

    assert strat_fast._scaled_min_hold_bars(1.0) == 10
    assert strat_slow._scaled_min_hold_bars(60.0) == 10
    assert strat_slow._scaled_min_hold_bars(240.0) == 3
    assert strat_default_30m._scaled_min_hold_bars(30.0) == 9
    assert strat_default_1h._scaled_min_hold_bars(60.0) == 7
