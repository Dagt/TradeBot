...
def backtest(
    ...
    equity_pct: float = typer.Option(1.0, "--equity-pct", help="Fraction of equity per trade"),
    risk_pct: float = typer.Option(0.0, "--risk-pct", help="Max loss over invested capital"),
    stop_loss_pct: float = typer.Option(0.0, "--stop-loss-pct", help="Price stop loss %"),
